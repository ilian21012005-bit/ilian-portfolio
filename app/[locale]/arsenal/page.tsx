                ...
                <TiltCard3d className="flex-1 min-w-0">
                  <SpotlightCard className="[&>div:last-child]:p-6 [&>div]:border-0 [&>div]:shadow-none h-full">
                    <div className="flex items-start gap-4">
                      <div
                        className={`p-2.5 rounded-xl w-fit shrink-0 ${accent === "accent" ? "bg-accent/20" : "bg-accent-secondary/20"}`}
                      >
                        <Icon
                          className={`w-7 h-7 ${accent === "accent" ? "text-accent" : "text-accent-secondary"}`}
                        />
                      </div>
                      <div>
