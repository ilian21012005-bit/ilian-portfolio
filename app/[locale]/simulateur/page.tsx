...
export default function SimulateurPage() {
  return (
    <PageLayout>
        ...
        >
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 md:p-8 shadow-[0_0_0_1px_rgba(255,255,255,0.03)] hover:border-crimson/20 transition-colors duration-300">
            <div className="flex flex-col md:flex-row md:items-start gap-6">
              <div className="flex items-center gap-3 shrink-0">
                <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-crimson/15 border border-crimson/25">
              ...
              <div className="space-y-3 min-w-0">
                <p className="text-foreground/85 text-base md:text-lg leading-relaxed">
                  ...
                  <code className="px-1.5 py-0.5 rounded bg-white/10 text-crimson font-mono text-sm">ip</code>,{" "}
                  <code className="px-1.5 py-0.5 rounded bg-white/10 text-crimson font-mono text-sm">dhclient</code>,{" "}
                  <code className="px-1.5 py-0.5 rounded bg-white/10 text-crimson font-mono text-sm">ping</code>,{" "}
                  <code className="px-1.5 py-0.5 rounded bg-white/10 text-crimson font-mono text-sm">save</code>,{" "}
                  <code className="px-1.5 py-0.5 rounded bg-white/10 text-crimson font-mono text-sm">reboot</code>.
                </p>
        ...
        <div className="max-w-4xl mx-auto px-6 mt-8 flex justify-center pb-12">
          <Link href="/arsenal" className="text-crimson hover:underline font-medium">
