    ...
    <PageLayout>
        ...
        <footer className="relative py-24 px-6 border-t border-white/10 overflow-hidden bg-gradient-to-b from-transparent to-accent/[0.02]">
          <div
            ...
            style={{
              backgroundImage: `
                repeating-linear-gradient(0deg, transparent 0px, transparent 39px, rgb(var(--accent-rgb) / 0.5) 39px, rgb(var(--accent-rgb) / 0.5) 40px),
                repeating-linear-gradient(90deg, transparent 0px, transparent 39px, rgb(var(--accent-rgb) / 0.5) 39px, rgb(var(--accent-rgb) / 0.5) 40px)
              `,
            }}
          />
